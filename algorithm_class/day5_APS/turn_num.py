...
for test_case in range(1, t + 1):
    ...
    # 90도 회전
    result_90 = turn_90(line, num_list)
    # 180도 회전
    result_180 = turn_90(line, result_90)
    # 270도 회전
    result_270 = turn_90(line, result_180)
    ...
    for i in range(line):
        ...
        print(''.join(map(str, result_270[i])))
